      ...
      <div className="relative z-10 flex-1 flex flex-col min-h-0">
        <header className="h-24 md:h-32 px-6 md:px-12 flex justify-between items-center shrink-0 relative">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={() => generatePDF(currentPlan!, activeTab)}
              className="flex items-center gap-2 px-4 py-2 bg-white/20 hover:bg-white/30 backdrop-blur-md rounded-xl border border-white/20 shadow-md text-sm font-bold transition-all cursor-pointer"
              style={{ color: activeTab === 'indoor' ? '#ffffff' : '#121212' }}
            >
              <Share2 className="w-4 h-4" />
              <span className="hidden md:inline">分享PDF</span>
            </button>
          </div>
        </header>
